ServerEvents.recipes(event => {
  ...
  event.recipes.create.splashing(
    [
      Item.of("gtceu:ochrum_dust").withChance(0.05), // Gold
      Item.of("gtceu:crimsite_dust").withChance(0.05), // Iron
      Item.of("gtceu:veridium_dust").withChance(0.05), // Copper
      Item.of("gtceu:asurine_dust").withChance(0.05), // Zinc
      Item.of("gtceu:scorchia_dust").withChance(0.05), // Lead
      Item.of("gtceu:scoria_dust").withChance(0.05), // Nickel
      Item.of("gtceu:diorite_dust").withChance(0.05), // Tin (Native to GT)
      Item.of("gtceu:granite_dust").withChance(0.05), // Iron (Native to GT)
      Item.of("gtceu:andesite_dust").withChance(0.05), // Iron (Native to GT)
      Item.of("gtceu:calcite_dust").withChance(0.05), // Silver (Native to GT)
    ],
    "gtceu:stone_dust",
  );

  event.recipes.gtceu
    .ore_washer("wash_stone_dust_create_1")
  ...
  event.recipes.gtceu
    .ore_washer("wash_stone_dust_create_2")
    .itemInputs("1x gtceu:stone_dust")
    .circuit(2)
  ...
  event.recipes.gtceu
    .ore_washer("wash_stone_dust_ow_blocks")
    .itemInputs("1x gtceu:stone_dust")
    .circuit(3)
...
event.recipes.gtceu
    .ore_washer("wash_stone_dust_geode_nether")
    .itemInputs("1x gtceu:stone_dust")
    .circuit(4)
    .chancedOutput("1x gtceu:basalt_dust", 1000, 0)
    .chancedOutput("1x gtceu:calcite_dust", 1000, 0)
    .chancedOutput("1x gtceu:blackstone_dust", 1000, 0)
    .duration(40)
    .EUt(8); // LV Tier
  ...
  dustProcessingMap.forEach((entry) => {
    event.recipes.create.splashing(
      [Item.of(entry.ore), Item.of("minecraft:clay_ball").withChance(0.25)],
      entry.dust,
    );

    event.recipes.gtceu
      .ore_washer(`wash_${entry.dust.split(":")[1]}`)
